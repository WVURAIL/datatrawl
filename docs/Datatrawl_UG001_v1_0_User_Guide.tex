...
\fancyfoot[L]{\small Datatrawl-UG001 v1.0}
...
\title{datatrawl Storage-Safe Archive Trawling Engine v0.1.0\\User Guide}
\author{West Virginia University}
\date{Datatrawl-UG001 v1.0 \\ July 1, 2026}
...
\begin{minipage}[t]{0.39\textwidth}
  ...
  {\small Datatrawl-UG001 v1.0, July 1, 2026}
\end{minipage}%
...
\begin{itemize}
  \item \code{--select} is interpreted by the analyzer (for the spectrum
        ...
        \code{614,706}, or ranges like \code{506-552}); a multi-item selection
        becomes independent products that resume and fail independently.
