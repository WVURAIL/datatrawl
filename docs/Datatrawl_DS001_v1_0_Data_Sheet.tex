...
\fancyhead[C]{\small Storage-Safe Archive Trawling Engine v0.1.0}
\fancyhead[R]{\small Product Specification}
\fancyfoot[L]{\small Datatrawl-DS001 v1.0}
...
\title{datatrawl Storage-Safe Archive Trawling Engine v0.1.0\\Product Specification}
\author{West Virginia University}
\date{Datatrawl-DS001 v1.0 \\ July 1, 2026}
...
\begin{minipage}[t]{0.39\textwidth}
  ...
  {\small Datatrawl-DS001 v1.0, July 1, 2026}
\end{minipage}%
...
{\small\color{TrawlGray}This product specification defines the v0.1.0 streaming
...
directory; records telescope, source, and reader. \\
...
\begin{itemize}
  ...
  \item \textbf{Reader}: \field{probe(path)} returns file metadata;
        ...
        \field{preflight(ctx)} verifies decode prerequisites.
\end{itemize}
...
\begin{itemize}
  \item Full pytest suite exercises the engine loop, kill/resume, ordering
        refusal, atomic writes, inventory handling, CLI output, and the
        built-in plugins.
